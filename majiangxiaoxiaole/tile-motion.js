/* Shared by the game and the deterministic physics regression checks. */
(function(root){
  ...
  const api={targets,step,assignLeaners,depth};
  if(typeof module!=='undefined')module.exports=api;else root.TileMotion=api;
})(globalThis);
