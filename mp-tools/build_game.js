...
const target = path.join(__dirname, '../majiang-mp/src/pages/game/game.vue');
  ...
  <view class="game">
    ...
    <view class="g-dock-custom">
      ...
      <view class="tool-capsule" @tap="handleToolClick('clear')">
        <image class="tool-art-img" src="/static/tools/tool-clear.png" mode="aspectFit" />
      ...
      <view class="tool-capsule" @tap="handleToolClick('shuffle')">
        <image class="tool-art-img" src="/static/tools/tool-shuffle.png" mode="aspectFit" />
      ...
      <view class="tool-capsule" @tap="handleToolClick('undo')">
        <image class="tool-art-img" src="/static/tools/tool-undo.png" mode="aspectFit" />
      ...
      <view class="tool-capsule" @tap="handleToolClick('magnet')">
        <image class="tool-art-img" src="/static/tools/tool-magnet.png" mode="aspectFit" />
    ...
    <view class="modal-overlay" v-if="refillModal.visible" @tap.self="refillModal.visible = false">
      <view class="tool-refill-dialog animate-pop">
        ...
        <view class="refill-art-card">
          <image class="refill-tool-img" :src="'/static/tools/' + refillModal.icon" mode="aspectFit" />
...
console.log('Successfully written unified game.vue to', target);
